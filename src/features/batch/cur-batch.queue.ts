...
export const CUR_BATCH_JOB_NAMES = {
  CUR_INGESTION: 'cur-ingestion',
  CUR_AGGREGATION: 'cur-aggregation',
} as const;
...
export const enqueueCurIngestionJob = async (
  data: CurBatchOptions = {},
  options?: JobsOptions,
) => {
  return curBatchQueue.add(CUR_BATCH_JOB_NAMES.CUR_INGESTION, data, options);
};

export const enqueueCurAggregationJob = async (
  data: CurBatchOptions = {},
  options?: JobsOptions,
) => {
  return curBatchQueue.add(CUR_BATCH_JOB_NAMES.CUR_AGGREGATION, data, options);
};
